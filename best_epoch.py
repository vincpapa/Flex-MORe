...
for dataset in datasets:
    ...
    for file in glob.glob(f'results/{dataset}/performance/*PDU*75*'):
        with open(file, 'rb') as handle:
            store_validation = pickle.load(handle)
    ...
    for file in glob.glob(f'results/{dataset}/performance/*PDU*25*'):
        with open(file, 'rb') as handle:
            store_validation = pickle.load(handle)
    ...
    for file in glob.glob(f'results/{dataset}/performance/*PDU*0$5*'):
        with open(file, 'rb') as handle:
            store_validation = pickle.load(handle)
