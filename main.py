...
def train(args, exp_id, val_best):
    ...
    if args.mo_method in ['USERADAFLEXMORE','PREFEADAFLEXMORE', 'ADAFLEXMORE','FLEXMORE_MGDA', 'FLEXMORE_EPO', 'FLEXMORE_SCALE', 'FLEXMORE_ABL', 'FLEXMORE_ABL_WOS', 'FLEXMORE_ABL_WOZ']:
        if 'r' in args.mode:
            tasks.append('1')
        if 's' in args.mode:
            tasks.append('4')
